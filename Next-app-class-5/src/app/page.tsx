export default function Home() {
  return (
    <div className="text-black font-bold">
      <nav className="flex h-12 w-full bg-pink-600 justify-between items-center p-10 gap-4">
      ...
      <div className="flex bg-blue-500 h-96 w-full justify-center items-center">
        This div contains Hero Section
      </div>
      <div className="bg-purple-500 w-full h-80 text-center flex justify-between p-10 gap-6">
