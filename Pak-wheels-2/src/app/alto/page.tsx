...
//         <Image src="/Alto.png" alt="Alto" width={350} height={400} className="rounded"/>
//       </div>
...
//         <Link href="/checkout">
//           <button className="bg-blue-800 text-white w-40 h-12 rounded my-4 hover:bg-blue-900 transition">
//             Make Payment
//           </button>
//         </Link>
//       </div>
